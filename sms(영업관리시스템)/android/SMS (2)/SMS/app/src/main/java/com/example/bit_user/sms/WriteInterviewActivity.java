...
public class WriteInterviewActivity extends AppCompatActivity {
    public static Activity wiaActivity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        wiaActivity=WriteInterviewActivity.this;
        ...
        new SendRequestCustom().execute(); //실행 후 flag=2
    ...
    public void onbtnClick(){
        ...
        btnCancel.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(WriteInterviewActivity.this,DialogCancelActivity.class);
                intent.putExtra("userToken",userToken);
                intent.putExtra("flag","WriteInterview");
    ...
    private class SendRequestInterview extends AsyncTask<Void,Void,String> { //background,progress,execcute
        String url=new ApiHost().getApi()+"write/consultation";
        String message;
        ...
        protected String doInBackground(Void... params) {
            ...
            try {
                ...
                System.out.println("index확인 : "+index);
        ...
        protected void onPostExecute(String s) {
            Toast.makeText(getApplicationContext(),"상담일지가 저장되었습니다.",Toast.LENGTH_SHORT).show();
...
/*
    private class SendRequestCustom2 extends AsyncTask<Void,Void,String> { //background,progress,execcute
        String url=new ApiHost().getApi()+write/consultation/listofsecondcustomer";
        String message;
        ...
        protected String doInBackground(Void... params) {
            ...
            try {
                ...
                nameValuePairs.add(new BasicNameValuePair("token",userToken));
                //nameValuePairs.add(new BasicNameValuePair("no",String.valueOf(index)));
                ...
                //토큰 혹은 false를 message에 담고서 비교
                message= EntityUtils.toString(resEntity);
                System.out.println("요청내용 2차고객 전달받음 : "+message);
        ...
        @Override
        protected void onPostExecute(String s) {
            ChangeJsonCustomer2Info(message);
        }
    ...
    private class SendRequestCustom extends AsyncTask<Void,Void,String> { //background,progress,execcute
        String url=new ApiHost().getApi()+"write/consultation/listOfcustomer";
        String message;

        @Override
        protected String doInBackground(Void... params) {
            String status=NetworkUtil.getConnectivityStatusString(WriteInterviewActivity.this);
        ...
        protected void onPostExecute(String s) {
            if(message.equals("네트워크가 연결되지 않아 종료됩니다.")){
                ...
                ActivityCompat.finishAffinity(WriteInterviewActivity.this);
    ...
    /*public void ChangeJsonCustomer2Info(String message){
        try {
        ...
        protected void onPostExecute(String s) {
            if(message.equals("네트워크가 연결되지 않아 종료됩니다.")){
                ...
                if(message.equals("accept")){
                    ...
                    new SendRequestInterview().execute();
